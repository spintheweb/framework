...
const Examples = [
	...
	{ wbll: `\\s('caption=\"Logon\"')e(';;@usr')\\a('placeholder=\"username\"')t(' ')w(';@pwd')\\a('placeholder=\"password\"')t(' ')b(';stw;logon')t('Logon')\\rt('Forgot password? ')a('/stw/reset')t('click here')`, html: `<input name="nome" value="Mario Rossi" placeholder="username"> <input type="password" name="altezza" value="1.78" placeholder="password"> <button value="stwlogon" name="stwAction" type="submit">Logon</button><br>Forgot password? <a href="http://localhost/stw/reset">click here</a>`, isForm: true },
];
